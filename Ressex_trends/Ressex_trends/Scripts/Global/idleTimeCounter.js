(function ($) {
    ...
    $.fn.idleTimeout = function (userRuntimeConfig) {
        ...
        //##############################
        var defaultConfig = {
            redirectUrl: "/logout.js",      // redirect to this url on logout. Set to "redirectUrl: false" to disable redirect
            ...
            dialogDisplayLimit: 300,       // Time to display the warning dialog before logout (and optional callback) in seconds. 180 = 3 Minutes
        ...
        //-----------USER STAY IN FUNCTION --------------//
        StayInUser = function () {
            var user_details = utility.getCookie("user_details");
